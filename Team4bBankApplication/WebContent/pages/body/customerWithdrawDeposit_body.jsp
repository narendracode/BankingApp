...
<div class="span5">
<!-- withdraw start -->
<form id="withdraw_form" action="/Team4bBankApplication/withdraw.iss" method="post" novalidate="novalidate">
<span class="label label-important">
...
<!-- deposit start -->
<form id="deposit_form" action="/Team4bBankApplication/deposit.iss" method="post" novalidate="novalidate">
<fieldset>
	<div class="fieldgroup">
                <label for="accountNumber">Select Account</label>
               <select name="accountNumber">
